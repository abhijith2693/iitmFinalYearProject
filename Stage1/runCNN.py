...
#network parameters
n_fmaps = (2,4,5,3)		#feature map description :
...
combine = [flair.data[0:41,0:41,0:41],t1.data[0:41,0:41,0:41],t2.data[0:41,0:41,0:41],t1c.data[0:41,0:41,0:41]] 
cost_ij = train_model(numpy.array(combine).astype('float32')/500.0,truth.data[16:25,16:25,16:25].reshape(9*9*9))
print cost_ij
"""
x : till 144
y till 200
